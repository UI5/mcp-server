...
async function getMockedModule() {
	...
	const {getGuidelines} = await esmock("../../../../src/tools/get_integration_cards_guidelines/guidelines.ts", {
		"node:fs/promises": {
...
const test = anyTest as TestFn<{
	...
	getGuidelines: typeof import("../../../../src/tools/get_integration_cards_guidelines/guidelines.js").getGuidelines;

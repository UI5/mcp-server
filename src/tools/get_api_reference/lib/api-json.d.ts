/* eslint-disable @typescript-eslint/no-redundant-type-constituents, @stylistic/indent-binary-ops, @typescript-eslint/no-explicit-any, @stylistic/indent, @stylistic/quote-props, @typescript-eslint/consistent-type-definitions, max-len, @stylistic/object-curly-spacing, @stylistic/spaced-comment, @typescript-eslint/consistent-indexed-object-style, @stylistic/operator-linebreak */
// File copied from https://github.com/UI5/typescript/tree/30351a86b685c2ee98001d542c1432c26a394113/packages/dts-generator/src/types

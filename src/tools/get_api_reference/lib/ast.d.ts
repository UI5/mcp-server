/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/consistent-type-definitions, max-len, @stylistic/object-curly-spacing, @stylistic/spaced-comment, @typescript-eslint/consistent-indexed-object-style, @stylistic/operator-linebreak */
